...
hl.treesitter = {
    ...
    TSAttribute = {fg = c.alt1},
    TSBoolean = {fg = c.booleans},
    TSCharacter = {fg = c.alt3},
    TSComment = {fg = c.commentGray, fmt = cfg.code_style.comments},
    TSConditional = {fg = c.alt1, fmt = cfg.code_style.keywords},
    TSConstant = {fg = c.alt3},
    TSConstBuiltin = {fg = c.alt3},
    TSConstMacro = {fg = c.alt3},
    TSConstructor = {fg = c.blue},
    TSError = colors.Fg,
    TSException = {fg = c.alt1Complementary},
    TSField = {fg = c.text},
    TSFloat = {fg = c.alt3},
    TSFunction = {fg = c.mainAlt, fmt = cfg.code_style.functions},
    TSFuncBuiltin = {fg = c.main, fmt = cfg.code_style.functions},
    TSFuncMacro = {fg = c.mainAlt, fmt = cfg.code_style.functions},
    TSInclude = {fg = c.alt4},
    TSKeyword = {fg = c.alt4, fmt = cfg.code_style.keywords},
    TSKeywordFunction = {fg = c.mainAlt, fmt = cfg.code_style.functions},
    TSKeywordOperator =  {fg = c.mainAlt, fmt = cfg.code_style.keywords},
    TSKeywordReturn =  {fg = c.alt1, fmt = cfg.code_style.keywords},
    TSLabel = colors.Red,
    TSMethod = {fg=c.mainAlt},
    TSNamespace = {fg=c.alt5},
    TSNone = colors.Fg,
    TSNumber = {fg=c.number},
    TSOperator = {fg=c.keywordGray},
    TSParameter = {fg=c.main},
    TSParameterReference = {fg=c.alt5Supplementary},
    TSProperty = {fg=c.text},
    TSPunctDelimiter = {fg=c.alt5},
    TSPunctBracket = {fg=c.text},
    TSPunctSpecial = {fg=c.text},
    TSRepeat = {fg = c.alt1Complementary, fmt = cfg.code_style.keywords},
    TSString = {fg = c.strings, fmt = cfg.code_style.strings},
    TSStringRegex = {fg = c.regex, fmt = cfg.code_style.strings},
    TSStringEscape = {fg = c.interpolated, fmt = cfg.code_style.strings},
    TSSymbol = {fg=c.alt4},
    TSTag = {fg=c.mainDarker1},
    TSTagDelimiter = {fg=c.mainDarker1},
    TSText = {fg=c.text},
    ...
    TSDanger = colors.Fg,
    TSType = {fg=c.alt4},
    TSTypeBuiltin = {fg=c.mainVariant},
    TSVariable = {fg = c.text, fmt = cfg.code_style.variables},
    TSVariableBuiltin = {fg = c.text, fmt = cfg.code_style.variables},
}
